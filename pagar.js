...
module.exports = {
    ...
    run: async(client, message, args) => {
      ...
      const id = args[0]
      dbP.set(`pay.emoji`, `<a:error:1060998173272846426>`)
      ...
      message.reply("<a:mundo:1060994974419779624> | Status de compra alterado para pago!").then(msg => setTimeout(() => msg.delete().catch(err => console.log(err)), 5000));
    }
}